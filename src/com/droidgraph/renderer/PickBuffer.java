...
public class PickBuffer extends PGraphicsAndroid3D {
	...
	public void fill(int arg) {
		super.fill(currentColor[0], currentColor[1], currentColor[2], currentColor[3]);
	}
	...
	public void stroke(int arg) {
		super.stroke(currentColor[0], currentColor[1], currentColor[2], currentColor[3]);
	}
	...
	public void setCurrentIDIndex(int id) {
		...
		Shared.offscreenBuffer.fill(currentColor[0], currentColor[1], currentColor[2], currentColor[3]);
	}
